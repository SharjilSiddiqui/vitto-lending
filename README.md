...
2. `chore: add TypeScript and Vite configuration`
3. `chore: add Express server baseline`
4. `chore: configure Prisma and PostgreSQL schema`
5. `feat: add business profile creation API`
6. `feat: add loan application creation API`
7. `feat: implement Zod validation middleware`
8. `feat: add structured API response helpers`
9. `feat: implement MSME credit scoring service`
10. `feat: add async decision job processing`
11. `feat: persist decisions and audit logs`
12. `feat: add health route and 404 handling`
13. `security: add helmet cors and rate limiting`
14. `docs: add Swagger API documentation`
15. `feat: build lending dashboard layout`
16. `feat: add React Hook Form validation`
17. `feat: connect frontend to lending APIs`
18. `feat: add decision polling and result card`
19. `chore: add Dockerfile and docker compose`
20. `docs: complete setup deployment and architecture notes`
